            ...
            <BreadcrumbItem>
              {isRenaming ? (
                <input
                  ...
                  className="text-sm bg-transparent text-foreground outline-none focus:ring-1 focus:ring-inset focus:ring-ring font-medium max-w-40 truncate cursor-pointer hover:text-primary"
                />
              ) : (
                <BreadcrumbPage
